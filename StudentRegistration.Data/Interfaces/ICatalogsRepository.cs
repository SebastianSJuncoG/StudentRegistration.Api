...
namespace StudentRegistration.Data.Interfaces
{
    public interface ICatalogsRepository
    {
        ...
        Task<IEnumerable<IdentificationType>> GetIdentificationType();
        /// <summary>
        ...
        Task<IdentificationType> GetIdentificationTypeId(int id);
        #endregion
        ...
        Task<IEnumerable<TypeOfEvent>> GetTypeOfEvent();
        ...
        Task<TypeOfEvent> GetTypeOfEventId(int id);
        #endregion
    }
}
